...
public class ProjectProperties extends Properties {
    ...
    static final String EXPORT_XSD_MODEL = "ExportXSDModel";
    ...
    static final String EXPORT_CODELISTS = "ExportCodelists";
    static final String EXPORT_WSDL = "ExportWSDL";
    static final String EXPORT_OPENAPI = "ExportOpenAPI";
    static final String EXPORT_WANTLIST = "ExportWantlist";
    ...
    public static Properties getDefaults() {
        ...
        defaults.setProperty(EXPORT_WANTLIST,"true");
