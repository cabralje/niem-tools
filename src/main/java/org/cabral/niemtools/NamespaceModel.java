...
public class NamespaceModel {
    ...
    static void cacheExternalSchemas() {
        ...
        if (externalSchemas == null || externalSchemas.isEmpty()) {
            Log.debug("cacheExternalSchemas: no external schemas");
            return;
        }
     ...
     * @param prefix
     * @param schemaURI
     * @return namespace class view for schema schemaURI in model modelPackage
     * as a UmlClassView; create it with prefix if doesn't exist
     */
     ...
     * @param prefix
     * @param tagName
     * @return name with namespace prefix for an attribute with name tagName as
     * a String
     */
