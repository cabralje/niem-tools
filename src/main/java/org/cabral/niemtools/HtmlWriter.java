 ...
 */
/**
 * HtmlWriter is responsible for exporting NIEM UML model mappings to an HTML file.
 * It generates an HTML table representing classes, attributes, and relations,
 * including their NIEM mapping properties such as XPath, type, property, base type,
 * multiplicity, and additional notes.
 * <p>
 * The generated HTML includes color-coded cells to indicate extensions, invalid mappings,
 * and changes from previous versions. The class relies on external models such as
 * NiemUmlModel and NamespaceModel to retrieve mapping data and validate NIEM properties.
 * </p>
 * <p>
 * Main responsibilities:
 * <ul>
 *   <li>Export the mapping spreadsheet as an HTML file with a styled table.</li>
 *   <li>Write individual rows and columns for UML items (classes, attributes, relations).</li>
 *   <li>Apply color coding for extensions, invalid mappings, and changes.</li>
 *   <li>Generate hyperlinks for known UML items.</li>
 *   <li>Handle exceptions and log errors during the export process.</li>
 * </ul>
 * </p>
 * @author James Cabral
 * @version 1.0
