...
class ConfigurationDialog extends JDialog {
	...
	ConfigurationDialog.FilePanel changelogPanel = new FilePanel(null, NiemTools.getProperty(NiemTools.IEPD_CHANGE_LOG_FILE_PROPERTY), fieldColumns, JFileChooser.FILES_ONLY);
	iepdPanel.add(changelogPanel, fieldLayout);
	
	iepdPanel.add(new JLabel("ReadMe File"), labelLayout);
	ConfigurationDialog.FilePanel readmePanel = new FilePanel(null, NiemTools.getProperty(NiemTools.IEPD_READ_ME_FILE_PROPERTY), fieldColumns, JFileChooser.FILES_ONLY);
